  ...
  <body>
    ...
    <script nonce="${nonce}">
      ...
      function render() {
        ...
        updateToolbarStatus();
        vscode.setState({ state, selectedClassId, selectedRelationId, connectFromClassId, connectPreviewPoint, connectDragActive, edgeEditorRelationId, canvasContextMenu, editingTitleClassId, editingMembersClassId, selectedTemplateId, zoom });
      }
